...
public class Administrador extends javax.swing.JFrame {
   ...
   //VICTOR-9959-23-10733
    ...
    String texto = buscartxt.getText().trim();
...
// --- FILTRO DE BUSQUEDA --- VICTOR 9959-23-10733
buscartxt.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
    @Override
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(36, 36, 36)
                .addComponent(buscartxt, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
